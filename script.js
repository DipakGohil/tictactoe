...
Array.from(boxes).forEach(element => {
    ...
    element.addEventListener('click', () => {
        ...
        if(count === 9 && !isgameover){
            ...
            isgameover = true;
            gameover.play();
            document.querySelector('.gameover-img').getElementsByTagName('img')[0].style.width = "150px";
        }
    })
})
...
reset.addEventListener('click', () => {
    ...
    document.querySelector('.gameover-img').getElementsByTagName('img')[0].style.width = "0px"
})
